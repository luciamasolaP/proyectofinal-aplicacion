 ...
 */
public class LabelProviderRelatedMethodsSeeds implements ITableLabelProvider {
	...
	public String getColumnText(Object element, int columnIndex) {
		...
		switch (columnIndex) {
			case 0 :
				...
				break;
			case 1 :
				result = MethodFormater.formatMethodIdToString(relatedMethodDescription.getRelatedMethod());
				break;
			case 2 :
	...
	public Image getColumnImage(Object element, int columnIndex) {
		  ...
		  ImageDescriptor descriptor = null;
		   if (columnIndex == 0 ){
			   if (((RelatedMethodDescription)element).getSelected().equals("yes"))
